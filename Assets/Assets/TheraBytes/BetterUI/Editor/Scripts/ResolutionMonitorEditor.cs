...
{ 
    ...
    public class ResolutionMonitorEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty curOptRes, curOptDpi, fallbackName, dpiManager, staticSizerMethods, autoIngameMonitor;
        ...
        void OnEnable()
        {
            this.autoIngameMonitor = serializedObject.FindProperty("autoCreateIngameMonitor");
        ...
        public override void OnInspectorGUI()
        {
            ...
            autoIngameMonitor.boolValue = EditorGUILayout.ToggleLeft(new GUIContent("Automatically Create Ingame Resolution Monitor", "An Ingame Resolution Monitor is needed to track resolution changes during runtime in builds."),
                autoIngameMonitor.boolValue);
