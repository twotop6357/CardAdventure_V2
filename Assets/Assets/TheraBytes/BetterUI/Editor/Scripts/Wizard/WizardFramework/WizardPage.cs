...
namespace TheraBytes.BetterUi.Editor
{
    public abstract class WizardPage
    {
        ...
        protected List<WizardPageElementBase> belowScrollbarElements = new List<WizardPageElementBase>();
        ...
        public void AddBelowScrollbar(WizardPageElementBase element, bool autoActivate = true)
        {
            belowScrollbarElements.Add(element);
            if (autoActivate)
            {
                element.Activate();
            }
        ...
        public void DrawGui()
        {
            ...
            bool disableNext = DrawElements(elements);

            EditorGUILayout.EndScrollView();

            DrawElements(belowScrollbarElements);
        ...
        private bool DrawElements(List<WizardPageElementBase> elements)
        {
