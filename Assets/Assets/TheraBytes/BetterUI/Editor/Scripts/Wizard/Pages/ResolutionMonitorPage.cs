...
namespace TheraBytes.BetterUi.Editor
{
    public class ResolutionMonitorPage : WizardPage
    {
        ...
        ValueWizardPageElement<bool> ingameResolutionMonitor;
        ...
        protected override void OnInitialize()
        {
            ...
            Add(new SeparatorWizardPageElement());
            Add(new InfoWizardPageElement("♠ Can the resolution change during runtime?"));
            Add(new InfoWizardPageElement("To properly track resolution changes, an 'Ingame Resolution Monitor' needs to be created. This can be done automatically. Do you want to automatically create an Ingame Resolution Monitor?",
                InfoType.InfoBox));

            ingameResolutionMonitor = new ValueWizardPageElement<bool>("ingameResolutionMonitor",
                (o, v) =>
                {
                    EditorGUILayout.BeginHorizontal();
                    v = GUILayout.Toggle(v, "Yes", EditorStyles.miniButtonLeft);
            ...
            Add(new CustomWizardPageElement((o) =>
            {
                ...
                {
                    Application.OpenURL(RootDirectory.HelpUrl + "ScreenConfigurations.html");
                }
        ...
        private void GenerateResolutionMonitor()
        {
            ...
            // ingame monitor
            rm.AutoCreateIngameMonitor = ingameResolutionMonitor.Value;
