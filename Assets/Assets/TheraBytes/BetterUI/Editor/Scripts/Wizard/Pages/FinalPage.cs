    ...
    public class FinalPage : WizardPage
    {
        ...
        protected override void OnInitialize()
        {
            ...
            Add(new InfoWithButtonWizardPageElement("You may want to check out the documentation.",
                "Open Documentation", () => Application.OpenURL(RootDirectory.HelpUrl)));
            ...
            Add(new InfoWithButtonWizardPageElement("Alternatively, you can join us on dicord.",
                "Join Discord", () => Application.OpenURL("https://discord.gg/x6qEv6heYh")));

            Add(new InfoWithButtonWizardPageElement("Or, you can send us a mail.",
                "Send Mail", () => Application.OpenURL("mailto:info@there-it-is.com?subject=Better%20UI")));
