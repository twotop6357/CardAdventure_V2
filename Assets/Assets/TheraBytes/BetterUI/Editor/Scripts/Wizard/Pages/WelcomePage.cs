    ...
    public class WelcomePage : WizardPage
    {
        ...
        protected override void OnInitialize()
        {
            ...
            if (skippingIsRecommended)
            {
                ...
                Add(new UnserializedButtonPageElement("Jump to Set-Root-Directory Page",
                    () => wizard.JumpToPage<SetRootDirectoryPage>()));
            ...
            CustomWizardPageElement skip = new CustomWizardPageElement(
                    (o) =>
                    {
