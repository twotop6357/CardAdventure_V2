    ...
    public class ExampleScenesPage : WizardPage
    {
        ...
        protected override string NextButtonText
        {
            get
            {
                ...
                installAny = packages.Any(o => o.SelectionState == InstallSelectionState.Install);
        ...
        protected override void OnInitialize()
        {
            ...
            AddBelowScrollbar(new RootFolderNotificationElement("BetterUI_Examples", showPredicate: () => installAny));

            // Overview
            Add(new SeparatorWizardPageElement());
            Add(CreateSelection("Overview"));
            Add(new InfoWithButtonWizardPageElement("This is the oldest example scene of Better UI. It shows the most releant features and is devided into categories: " +
                "Transitions, Better Image, Better Text and Layout",
                "Preview", () => Application.OpenURL("https://better-ui.there-it-is.com/examples/overview-example/index.html")));
            ...
            // Navigation
            Add(new SeparatorWizardPageElement());
            Add(CreateSelection("Navigation"));
            Add(new InfoWithButtonWizardPageElement("This example shows Better UIs navigation features for gamepads.",
               "Preview", () => Application.OpenURL("https://better-ui.there-it-is.com/examples/navigation-example/index.html")));

#if !ENABLE_INPUT_SYSTEM
                Add(new InfoWizardPageElement(@"This example scene uses Unitys ""new"" input system, which doesn't seem to be installed.", InfoType.ErrorBox));
#endif
            if (!ThirdPartySupportPage.IsBetterTextMeshProInstalled(out _))
            {
                Add(new InfoWizardPageElement(@"This example scene uses the Better Text Mesh Pro package. Make sure you have TextMesh Pro installed and then install the Better UI versions in the ""Third Party"" page of this wizard.", InfoType.ErrorBox));
            }

            // Ghost
            Add(new SeparatorWizardPageElement());
            Add(CreateSelection("Ghost"));
            Add(new InfoWithButtonWizardPageElement("This example shows some animation features as well as a movable mask where the masked sprite in the hierarchy below stays at a certain position. " +
                "This is achieved using Anchor Overrides.",
                 "Preview", () => Application.OpenURL("https://better-ui.there-it-is.com/examples/ghost-example/index.html")));
            ...
            Add(new InfoWithButtonWizardPageElement("This example shows realtime detection of screen sizes and portrait / landscape detection. ", 
                "Preview", () => Application.OpenURL("https://better-ui.there-it-is.com/examples/resolution-tracking-example/index.html")));
            ...
            Add(new InfoWithButtonWizardPageElement("This example shows how you can use AnchorOverrides to create animated UIs. " +
                ...
                "Preview", () => Application.OpenURL("https://better-ui.there-it-is.com/examples/anchor-animation-example/index.html")));
            ...
            Add(new InfoWithButtonWizardPageElement("You will find just a long text and a toggle in this exampke. If you hit the toggle everything becomes big. " +
                "This is achieved through custom screen tags in screen configurations.",
                "Preview", () => Application.OpenURL("https://better-ui.there-it-is.com/examples/accessibility-mode-example/index.html")));
                ...
                foreach (var itm in items)
                {
                    switch (itm.SelectionState)
                    {
                        ...
                        case InstallSelectionState.Remove:
                            try
                            {
                                System.IO.File.Delete(itm.PathToFolder + ".meta");
                                System.IO.Directory.Delete(itm.PathToFolder, true);
                            }
                            catch
                            {
        ...
        {
            string package = RootDirectory.GetAbsolutePath(string.Format("BetterUI/packages/Example_{0}.unitypackage", exampleName));
            string folder = RootDirectory.GetAbsolutePath(string.Format("BetterUI_Examples/{0}", exampleName));
