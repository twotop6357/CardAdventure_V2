    ...
    public class ResolutionPicker : EditorWindow
    {
        ...
        internal class GameViewSize
        {
            ...
            public object ToInternalObject()
            {
                ...
                System.Type t = ass.GetType("UnityEditor.GameViewSize");
                System.Type sizeType = ass.GetType("UnityEditor.GameViewSizeType");
                var constructor = t.GetConstructor(new System.Type[] { sizeType, typeof(int), typeof(int), typeof(string) });
        ...
        void RefreshSizes()
        {
            ...
            System.Type gameSizesType = System.Type.GetType("UnityEditor.GameViewSizes," + assembly);
            System.Type gameSizeGroupType = System.Type.GetType("UnityEditor.GameViewSizeGroup," + assembly);
            gameSizeType = System.Type.GetType("UnityEditor.GameViewSize," + assembly);
        ...
        void OnGUI()
        {
            ...
            if (gameView == null) // still null?
            {
                ...
                {
                    gameView = EditorWindow.GetWindow(System.Type.GetType("UnityEditor.GameView," + assembly));
                }
            ...
            if (this.displayScreenConfigs)
            {
                ...
                System.Action<ScreenTypeConditions, int, int> applyScreenConfig = (config, width, height) =>
                {
        ...
        private void AddSizeToUnity(string name, int width, int height)
        {
            ...
            try
            {
                ...
                Assembly ass = typeof(EditorApplication).Assembly;
                System.Type gameViewSizesType = ass.GetType("UnityEditor.GameViewSizes");
        ...
        void AddSize(System.Type gameSizeType, object gameSize, int index, bool isCustom)
        {
