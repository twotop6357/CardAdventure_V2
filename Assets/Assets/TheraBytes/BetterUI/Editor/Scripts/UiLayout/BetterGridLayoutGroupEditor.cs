...
namespace TheraBytes.BetterUi.Editor
{
    ...
    public class BetterGridLayoutGroupGridEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty keepCellAspectRatio;
        ...
        protected virtual void OnEnable()
        {
            ...
            this.keepCellAspectRatio = base.serializedObject.FindProperty("keepCellAspectRatio");
        ...
        private void DrawSettings(string configName, SerializedProperty prop)
        {
            ...
            keepCellAspectRatio = prop.FindPropertyRelative("KeepCellAspectRatio");
            ...
            if (constraint.enumValueIndex > 0)
            {
                ...
                if(fit.boolValue)
                {
                    EditorGUILayout.PropertyField(keepCellAspectRatio);
                }
