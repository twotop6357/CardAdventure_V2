...
namespace TheraBytes.BetterUi.Editor
{
    public static class Betterizer
    {
            ...
            where TBetter : T
        {
            ...
            if (source is TBetter)
            {
                ...
                if (EditorUtility.DisplayDialog("Already Good Enough",
                    ...
                    typeName, System.Environment.NewLine),
                    "Yes", "No"))
                {
            ...
            where TBetter : T
        {
            ...
            Undo.SetCurrentGroupName(string.Format("Make Better {0}", System.DateTime.Now.ToFileTimeUtc()));
        ...
        static IEnumerable<KeyValuePair<FieldInfo, object>> CollectAllFieldValues(System.Type type, object source,
        ...
        static IEnumerable<FieldInfo> CollectFieldInfosRecursively(System.Type type)
        {
        ...
        static IEnumerable<FieldInfo> CollectFieldInfos(System.Type type)
        {
        ...
        public static void CopyValuesRecursive(System.Type type, object source, object target)
        {
        ...
        public static void CopyValues(System.Type type, object source, object target)
        {
            FieldInfo[] myObjectFields = type.GetFields(
                BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance);
