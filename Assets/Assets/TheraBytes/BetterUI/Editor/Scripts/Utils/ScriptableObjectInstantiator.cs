...
namespace TheraBytes.BetterUi
{
    public static class ScriptableObjectInstantiator
    {
        ...
        [MenuItem("Tools/Better UI/Settings/Select Global Applier", false, 2)]
        static void SelectGlobalApplier()
        {
            Selection.objects = new UnityEngine.Object[] { GlobalApplier.Instance };
        }
