...
namespace TheraBytes.BetterUi.Editor.ThirdParty
{
	...
	public static class ElementAdderMenuBuilder {
		...
		/// </returns>
		/// <seealso cref="IElementAdderMenuBuilder{TContext}.SetContractType(System.Type)"/>
		...
		/// </returns>
		/// <seealso cref="IElementAdderMenuBuilder{TContext}.SetContractType(System.Type)"/>
		public static IElementAdderMenuBuilder<TContext> For<TContext>(System.Type contractType) {
