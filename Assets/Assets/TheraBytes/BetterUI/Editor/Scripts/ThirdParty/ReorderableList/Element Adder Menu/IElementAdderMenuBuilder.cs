...
namespace TheraBytes.BetterUi.Editor.ThirdParty
{
	...
	public interface IElementAdderMenuBuilder<TContext> {
		...
		void SetContractType(System.Type contractType);
		...
		void SetTypeDisplayNameFormatter(System.Func<System.Type, string> formatter);
		...
		/// </exception>
		void AddTypeFilter(System.Func<System.Type, bool> typeFilter);
