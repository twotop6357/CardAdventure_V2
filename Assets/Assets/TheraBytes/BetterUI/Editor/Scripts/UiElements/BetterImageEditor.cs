...
namespace TheraBytes.BetterUi.Editor
{
    ...
    public class BetterImageEditor : GraphicEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            raycastPaddingFallback = base.serializedObject.FindProperty("raycastPaddingFallback");
            raycastPaddingCollection = base.serializedObject.FindProperty("raycastPaddingSizers");
        ...
        private void DrawSpriteSettings(string configName, SerializedProperty property)
        {
            ...
            SerializedProperty flippingMode = property.FindPropertyRelative("FlippingMode");

            SpriteGUI(spriteProp);

            // coloring and flipping not supported for Filled yet.
            if (image.type != Image.Type.Filled)
            {
                EditorGUILayout.PropertyField(flippingMode);
