...
{
    [HelpURL(RootDirectory.HelpUrl + "ResolutionMonitor.html")]
    public class ResolutionMonitor : SingletonScriptableObject<ResolutionMonitor>
    {
        static string FilePath { get { return RootDirectory.GetPath("Resources/ResolutionMonitor"); } }
        ...
        [SerializeField]
        bool autoCreateIngameMonitor = true;
        public bool AutoCreateIngameMonitor { get { return autoCreateIngameMonitor; } set { autoCreateIngameMonitor = value; } }

        public List<ScreenTypeConditions> OptimizedScreens { get { return optimizedScreens; } }

        Dictionary<string, ScreenTypeConditions> lookUpScreens = new Dictionary<string, ScreenTypeConditions>();
        ...
        {
            return ResolutionMonitor.Instance.GetConfigInternal(name);
        }

        private ScreenTypeConditions GetConfigInternal(string name)
        {
            ...
            {
                var config = optimizedScreens.FirstOrDefault(o => o.Name == name);
...
#if UNITY_EDITOR
        static System.Type gameViewType = null;
...
#if UNITY_2018_1_OR_NEWER
        private static void PlayModeStateChanged(UnityEditor.PlayModeStateChange stateChange)
#else
private static void PlayModeStateChanged()
        ...
        public static void Update()
        {
            ...
            {
                // Resume driven rect transform trackers one frame later,
                // so, they can update in between without dirtying the rect transforms.
        ...
        public void ResolutionChanged()
        {
            ...
            {
                GlobalApplier.Instance.UpdateCachedValues();
