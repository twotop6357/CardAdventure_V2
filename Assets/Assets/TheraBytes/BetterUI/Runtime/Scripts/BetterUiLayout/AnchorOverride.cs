...
namespace TheraBytes.BetterUi
{
    ...
    [HelpURL(RootDirectory.HelpUrl + "AnchorOverride.html")]
    ...
    public class AnchorOverride : UIBehaviour, IResolutionDependency
    {
        ...
        protected override void OnValidate()
        {
            ...
            // prevent warning in the console
            UnityEditor.EditorApplication.delayCall += () =>
            {
                // because of the delay, this object might became null
                // (this usually happens when switching to play mode when "Reload Scene" is enabled)
                if (this != null) 
                {
                    UpdateAnchors(true);
                }
