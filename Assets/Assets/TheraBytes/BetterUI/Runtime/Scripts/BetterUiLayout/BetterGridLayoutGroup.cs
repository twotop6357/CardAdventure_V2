...
namespace TheraBytes.BetterUi
{
    ...
    [ExecuteInEditMode]
#endif
    [HelpURL(RootDirectory.HelpUrl + "BetterGridLayoutGroup.html")]
    ...
    public class BetterGridLayoutGroup : GridLayoutGroup, IResolutionDependency
    {
        ...
        public class Settings : IScreenConfigConnection
        {
            ...
            public Settings(BetterGridLayoutGroup grid)
            {
                ...
                this.Fit = grid.fit;
                this.KeepCellAspectRatio = grid.keepCellAspectRatio;
            }
        ...
        public bool KeepCellAspectRatio
        {
            get { return keepCellAspectRatio; }
            set { Set(value, (o) => keepCellAspectRatio = o, (s, o) => s.KeepCellAspectRatio = o); }
        }
        ...
        [SerializeField]
        bool keepCellAspectRatio = false;
        ...
        public void CalculateCellSize()
        {
            ...
            // cell size
            CellSizer.CalculateSize(this, nameof(CellSizer));

            if (fit)
            {
                Vector2 size = CellSizer.LastCalculatedSize;
                float aspectRatio = CellSizer.OptimizedSize.x / CellSizer.OptimizedSize.y;
        ...
        void ApplySettings(Settings settings)
        {
            ...
            this.keepCellAspectRatio = settings.KeepCellAspectRatio;
        }
