...
namespace TheraBytes.BetterUi
{
    ...
    [ExecuteInEditMode]
#endif
    [HelpURL(RootDirectory.HelpUrl + "BetterOffsetter.html")]
    ...
    public class BetterOffsetter : UIBehaviour, ILayoutController, ILayoutSelfController, IResolutionDependency
    {
        ...
        void ApplySize()
        {
            ...
            {
                pos.y = AnchoredPositionYSizer.CalculateSize(this, nameof(AnchoredPositionYSizer));
