...
namespace TheraBytes.BetterUi
{
    ...
    [ExecuteInEditMode]
#endif
    [HelpURL(RootDirectory.HelpUrl + "BetterText.html")]
        ...
        void CalculateSize()
        {
            ...
            switch (fitting)
            {
                case FittingMode.SizerOnly:
                    ...
                    base.fontSize = Mathf.RoundToInt(FontSizer.CalculateSize(this, nameof(FontSizer)));
                    break;
                ...
                case FittingMode.StayInBounds:
                    ...
                    int size = Mathf.RoundToInt(FontSizer.CalculateSize(this, nameof(FontSizer)));
                    ...
                    base.fontSize = (bestFit < size) ? bestFit : size;
