...
namespace TheraBytes.BetterUi
{
    ...
    [ExecuteInEditMode]
#endif
    [HelpURL(RootDirectory.HelpUrl + "InteractionArea.html")]
    ...
    public class InteractionArea : Graphic, ICanvasRaycastFilter, IResolutionDependency
    {
        ...
        FloatSizeModifier CornerRadius { get { return cornerRadiusConfigs.GetCurrentItem(cornerRadiusFallback); } }
        public float CurrentCornerRadius { get { return CornerRadius.LastCalculatedSize; } }
        ...
        {
            CornerRadius.CalculateSize(this, nameof(CornerRadius));
        }
